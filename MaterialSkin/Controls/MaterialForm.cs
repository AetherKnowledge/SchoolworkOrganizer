namespace MaterialSkin.Controls
{
    ...
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        {
            get { return drawerControl.LogoPanelBackColor; }
            set { drawerControl.LogoPanelBackColor = value; }
        }

        [Category("Logo")]
        public Image BigLogo
        {
            get => drawerControl.BigLogo;
            set => drawerControl.BigLogo = value;
        }
        [Category("Logo")]
        public Image SmallLogo
        {
            get => drawerControl.SmallLogo;
            set => drawerControl.SmallLogo = value;
        }

        [Category("Logo")]
        public PictureBoxSizeMode BigLogoSizeMode
        {
            get => drawerControl.BigLogoSizeMode;
            set => drawerControl.BigLogoSizeMode = value;
        }
        [Category("Logo")]
        public Rectangle BigLogoBounds
        {
            get => drawerControl.BigLogoBounds;
            set => drawerControl.BigLogoBounds = value;
        }
        [Category("Logo")]
        public DockStyle BigLogoDockStyle
        {
            get { return drawerControl.BigLogoDockStyle; }
            set { drawerControl.BigLogoDockStyle = value; }
        }
        [Category("Logo")]
        public int LogoPanelHeight
        {
            get => drawerControl.LogoPanelHeight;
            set => drawerControl.LogoPanelHeight = value;
        }

        [Category("Drawer")]
        public Image LogoutImage
        {
            get => drawerControl.LogoutImage;
            set => drawerControl.LogoutImage = value;
        }
        ...
        {
            get => drawerControl.BackColor;
            set => drawerControl.BackColor = value;
        }

        [Category("Drawer")]
        public bool DisplayImage
        {
            get => drawerControl.DisplayImage;
            set => drawerControl.DisplayImage = value;
        }
        [Category("Drawer")]
        public Image DrawerImage
        {
            get => drawerControl.Image;
            set => drawerControl.Image = value;
        }
        [Category("Drawer")]
        public string DrawerLabelText
        {
            get { return drawerControl.LabelText; }
            set { drawerControl.LabelText = value; }
        }

        [Category("Drawer")]
        public PictureBoxSizeMode DrawerImageSizeMode
        {
            get => drawerControl.ImageSizeMode;
            set => drawerControl.ImageSizeMode = value;
        }
        [Category("Drawer")]
        public Size DrawerImageSize
        {
            get => drawerControl.ImageSize;
            set => drawerControl.ImageSize = value;
        }
        ...
        protected MaterialDrawer drawerControl = new MaterialDrawer();
